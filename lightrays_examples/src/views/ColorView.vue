...
watchEffect(() => {
  ...
  document.documentElement.style.setProperty("--l-range", lRange.value);
  document.documentElement.style.setProperty("--c-range", cRange.value);
  document.documentElement.style.setProperty("--h-range", hRange.value);

  document.documentElement.style.setProperty("--l-fac-darkest", l_fac1.value);
  document.documentElement.style.setProperty("--l-fac-dark", l_fac2.value);
  document.documentElement.style.setProperty("--l-fac-light", l_fac3.value);
  document.documentElement.style.setProperty("--l-fac-lightest", l_fac4.value);

  document.documentElement.style.setProperty("--c-fac-darkest", c_fac1.value);
  document.documentElement.style.setProperty("--c-fac-dark", c_fac2.value);
  document.documentElement.style.setProperty("--c-fac-light", c_fac3.value);
  document.documentElement.style.setProperty("--c-fac-lightest", c_fac4.value);

  document.documentElement.style.setProperty("--h-fac-darkest", h_fac1.value);
  document.documentElement.style.setProperty("--h-fac-dark", h_fac2.value);
  document.documentElement.style.setProperty("--h-fac-light", h_fac3.value);
  document.documentElement.style.setProperty("--h-fac-lightest", h_fac4.value);
