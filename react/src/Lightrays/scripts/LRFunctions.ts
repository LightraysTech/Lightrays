...
export enum LightTimes {sunrise = "#F7F9E7", sunset = "#F7F9E7", day = "#d9e8f7", night = "#18436E"}
...
export const setTheme = (theme: string) => {
    ...
    let cssvars = [
        ...
        ["box-shadow", "0px 1.6px 7px rgb(0 0 0 / 9%)", "1.2px 1.2px 6px rgba(0, 0, 0, 0.75)"],
        ["box-shadow-active", "1px 1px 3px rgba(0, 0, 0, 0.25)", "1px 1px 3px rgba(0, 0, 0, 0.75)"], 
