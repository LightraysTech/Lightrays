...
let ease =window.getComputedStyle(document.body).getPropertyValue("--curve-ease-in")
ctx1.setTransform(3,0,0,-3,0,300)
...
<template>
<canvas ref="graph1" width="300" height="300"></canvas>
</template>
