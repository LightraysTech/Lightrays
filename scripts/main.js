...
if (navHTMl != undefined || navHTMl != null) {
    //Number of menuLinks
    var menuItems = navHTMl.split("</div>").length-1;
    ...
    if (menuMiddle % 1 == 0) {
        var menuMiddle = document.querySelector("nav .wrap-container div:nth-child(" + menuMiddle + ")");
        menuMiddle.style.margin = "0 100px 0 0";
    } else {
        console.error("LWD2.0 Error: The menu must have a even number of menu items");
    }
}